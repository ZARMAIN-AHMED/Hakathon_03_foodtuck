import { shipengine } from "@/app/lib/helper/sipEngine"; // Import ShipEngine client
...
// Define the "ship from" address (e.g., your warehouse or business address)
    ...
    const shipmentDetails = await shipengine.getRatesWithShipmentDetails({
      ...
      rateOptions: {
        carrierIds: [
          process.env.SHIPENGINE_FIRST_COURIER || "se-1588051",
          process.env.SHIPENGINE_SECOND_COURIER || "se-1588052",
          process.env.SHIPENGINE_THIRD_COURIER || "se-1588053",
          process.env.SHIPENGINE_FOURTH_COURIER || "se-1588237",

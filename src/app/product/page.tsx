...
//   // Fetch products from an API (MockAPI or your own API)
//   useEffect(() => {
//     const fetchProducts = async () => {
//       setLoading(true);
//       try {
//         const res = await fetch('https://677d57d14496848554ca2f9f.mockapi.io/product'); // Replace with your API endpoint
...
//   // Handle showing a specific number of products per page
//   const handleItemsPerPageChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
//     setItemsPerPage(Number(e.target.value));
//   };
...
//                 <Link href={`/productss/${product.id}`} key={product.id}>
...
//           <h2 className="text-xl font-bold mb-4">Category</h2>
//           <div className="flex flex-col gap-2">
//             {["Sandwiches", "Burger", "Chicken Chup", "Drink", "Pizza", "Non Veg"].map((category, index) => (
//               <label key={index} className="flex items-center gap-2">
//                 <input
//                   type="checkbox"
//                   checked={selectedCategories.includes(category)}
